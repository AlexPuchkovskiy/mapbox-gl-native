...
OfflineRegion OfflineDatabase::updateMetadata(OfflineRegion&& region, const OfflineRegionMetadata& metadata) {
    // clang-format off
    Statement stmt = getStatement(
    ...
    return OfflineRegion(region.id, region.definition, metadata);
}
